...
from app.repositories.base import MongoCatalogoRepository
...
class TestAsyncMongoCatalogoRepository:
    @pytest.fixture
    ...
    def repository(self, test_entities):
        ...
        repo = MongoCatalogoRepository[SampleEntity, str](key_name="id", model_class=SampleEntity)
    ...
    async def test_find_with_empty_memory(self):
        ...
        empty_repo = MongoCatalogoRepository[SampleEntity, str](key_name="id", model_class=SampleEntity)
